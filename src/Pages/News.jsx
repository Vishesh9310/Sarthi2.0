      ...
      <section className='bg-sky-200'>
        <div className='inline-flex px-40 py-5 h-100'>
          <div className='w-1/2 h-full py-10'>
            ...
            <Link to="/signup" className='w-fit border-sky-600 text-sky-600 border-2 hover:bg-sky-300 px-4 py-1 mt-3 rounded-2xl'>See Case Studies</Link>
          </div>
          <img src={logo1} alt="" className='bg-blue-700 mx-10 w-1/2 rounded-br-[25%] rounded-tl-[25%]' />
        </div>

        <div className='px-24 py-5 grid grid-cols-5 w-full'>
          <div className='inline-flex items-center'>
            <img src={logo1} alt="" className='h-10 rounded-[100%] mr-3' />
            <h3 className='text-center font-bold text-gray-600'> logoipsum</h3>
          </div>
          <div className='inline-flex items-center'>
            <img src={logo1} alt="" className='h-10 rounded-[100%] mr-3' />
            <h3 className='text-center font-bold text-gray-600'> logoipsum</h3>
        ...
        <div className='px-24 py-18'>
          ...
          <div className='grid grid-cols-4 w-full gap-8'>
            <div className='rounded-tl-4xl rounded-br-4xl bg-sky-300 pb-5 h-fit hover:bg-sky-400'>
              ...
              <h3 className='px-5 mt-50'>Stretegic Planning</h3>
        ...
        <div className='bg-sky-300 shadow-2xl shadow-sky-700 p-24 w-fit rounded-4xl mx-10 mb-20 inline-flex'>
          ...
          <div className='w-1/2 pl-10'>
            <h3 className='font-bolder text-2xl pl-10 pr-10 pb-10'>Get the insights you need to worry less & grow more</h3>
            <div className='pb-3'>
