...
function lable() {
  return (
    <>
    <marquee behavior="slide" direction="right" className="bg-sky-400" loop="2" scrollamount="10">
    <div className='px-24 text-white inline-flex gap-5 content-center w-full bg-sky-400'>
        <Link to="/contactus" className=' py-5 px-3 hover:bg-sky-500'>
        ...
        <Link to="/about" className=' py-5 px-3 hover:bg-sky-500'>
